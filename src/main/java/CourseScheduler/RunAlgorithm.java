...
public class RunAlgorithm {
	...
	private Course getPrereq(Course recursCourse) {
		...
		} else if (!childPrereqs.isEmpty()) { //Children Left; Recursive Case
	...
	/**
	 * Used to test lists of Courses in the generateSchedule() method of CourseScheduler.java, as well as to test the
	 * entirety of RunAlgorithm.java.
	 * @return test The list of Courses to use in the tests
	 */
	public List<Course> testListOfCourses()
	{
		List<String> prereqsOfA = new ArrayList<String>();
		prereqsOfA.add("Test-F");
		...
		Course courseE = new Course("", "Test E", "", 2, "", "Test-E", prereqsOfE, new ArrayList<String>(), -999, "Test-F");
		
		List<String> prereqsOfG = new ArrayList<String>();
		prereqsOfG.add("Test-H");
		Course courseG = new Course("", "Test G", "", 2, "", "Test-G", prereqsOfG, new ArrayList<String>(), -999, "Test-H");
		
		List<String> prereqsOfH = new ArrayList<String>();
		Course courseH = new Course("", "Test H", "", 1, "", "Test-H", prereqsOfH, new ArrayList<String>(), -999, "");
		...
		coreqZ.add("Test-A");
		Course courseZ = new Course("", "Test Z", "", 1, "", "Test-Z", prereqsOfZ, coreqZ, -999, "");
